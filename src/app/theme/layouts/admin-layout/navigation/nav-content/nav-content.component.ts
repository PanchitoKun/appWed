...
import { AntDesignOutline, BgColorsOutline, ChromeOutline, CreditCardOutline, DashboardOutline, FontSizeOutline, LoginOutline, ProfileOutline, QuestionOutline } from '@ant-design/icons-angular/icons';
...
export class NavContentComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.navigations = this.filterNavigationItems(NavigationItems); // Filter navigation items based on role
  }
  ...
  ngAfterViewInit() {
    if (this.windowWidth < 1025) {
      ...
      if (navbarElement) {
        ...
        console.error('Element not found: .coded-navbar');
      }
    }
  }
